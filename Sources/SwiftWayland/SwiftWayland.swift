...
struct SwiftWayland {
    static func main() async {
        ...
        event_loop: for await ev in WaylandEvents.events() {
            ...
            case .key(let code, let state):
                ...
                print("HERE", code, state)
            case .global(let name, let id, let version):
                switch name {
                case "wl_compositor":
            ...
            case .globalRemove(let id):
                print("Global removed:", id)
            }
            if compositor != nil, wmBase != nil && surface == nil {
                print("next stage")
                ...
                xdg_toplevel_set_title(toplevel, "Swift Wayland Test")
    ...
    static func drawFrame() {
        ...
        glClearColor(0.1, 0.2, 0.3, 1.0)  // dark bluish background
    ...
    static let onGlobal:
        @convention(c) (
            ...
            WaylandEvents.send(.global(name: iface, id: name, version: version))
    ...
    static let onGlobalRemove:
        @convention(c) (
            ...
            WaylandEvents.send(.globalRemove(id: name))
        }
...
enum WaylandEvent {
    case global(name: String, id: UInt32, version: UInt32)
    case globalRemove(id: UInt32)
